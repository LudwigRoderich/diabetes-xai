...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--thresh-metric", choices=["f1", "recall", "prauc"], default="f1")
...
def artifacts_exist(dataset_tag: str) -> bool:
    """Verifica si ya existen modelos y reportes entrenados para el pipeline de clasificación."""
    models = Persistence.list_saved_models(dataset_tag)
    results = Persistence.list_saved_results(dataset_tag)
    return len(models) > 0 and len(results) > 0
